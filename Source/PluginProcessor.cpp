...
void ThreeQAudioProcessor::updateCoefficients(Coefficients &old, const Coefficients &replacements)
{
    *old = *replacements;
}

void ThreeQAudioProcessor::updateLowCutFilters(const ChainSettings &chainSettings)
{
...
void ThreeQAudioProcessor::updateHighCutFilters(const ChainSettings &chainSettings)
{
